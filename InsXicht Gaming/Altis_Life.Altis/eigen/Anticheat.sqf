...
_Admins = ["76561198075941270"]; 			//Add your admin UID here
_Use_Life_fnc_MP = false;					//If you are using altis life change this to true

//Add new cheat files & variables & menus to these lists
_DetectedFiles = ["wookie.sqf","wookie_wuat\start.sqf","lystoarma3\start.sqf","help.sqf","hack.sqf","cheat.sqf","JxMxE.sqf","JME.sqf","wookiev5.sqf","menu.sqf"];			
...
_exists = loadFile "eigen\AdminMenu.sqf";
if(_exists != "") then {
	call compile preprocessfilelinenumbers "eigen\AdminMenu.sqf";
};