...
_unit setVariable["name",player getVariable["realname",name player],TRUE];
...
_unit spawn
{
	...
	waitUntil {_Timer ctrlSetText format["Respawn in %1 verfuegbar!",[(_maxTime - time),"MM:SS.MS"] call BIS_fnc_secondsToString]; 
	...
	_Timer ctrlSetText "Du kannst nicht Respawnen";
};
