...
"Mietpreis: <t color='#8cff9b'>$%1</t><br/>Kaufpreis: <t color='#8cff9b'>$%2</t><br/>Max Geschwindigkeit: %3 km/h<br/>Ps: %4<br/>Beifahrer: %5<br/>Laderaum: %6<br/>Treibstoff: %7<br/>Panzerung: %8",
