...
if(life_cash < _basePrice) exitWith {hint format["Sie haben nicht genug Geld, um dieses Fahrzeug zu kaufen.\n\nFehlender Betrag: $%1",[_basePrice - life_cash] call life_fnc_numberText];};
if(!([_className] call life_fnc_vehShopLicenses) && _className != "B_MRAP_01_hmg_F") exitWith {hint "Du hast nicht die benoetigte Lizens!"};
