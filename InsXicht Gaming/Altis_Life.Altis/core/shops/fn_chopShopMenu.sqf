...
*/
if(life_action_inUse) exitWith {hint "Eine Aktion wird bereits bearbeitet..."};
...
//Error check
if(count _nearVehicles == 0) exitWith {titleText["Es gibt in der Nähe keine Fahrzeuge zu verkaufen.","PLAIN"];};
if(!(createDialog "Chop_Shop")) exitWith {hint "Es gab ein Problem den Gebrauchtwagenhaendler zu befragen"};
