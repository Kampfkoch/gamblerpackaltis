...
if(_value > 0) then
{
	[[0,format["Bei einer Fahrzeugdurchsuchung wurde Schmuggelware im Wert von $%1 beschlagnahmt.",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	life_atmcash = life_atmcash + _value;
	_vehicle setVariable["Trunk",[],true];
}
	else
{
	hint "Es befindet sich nichts illegales im Fahrzeug.";
};