...
if((_vehicle getVariable ["trunk_in_use",false])) exitWith {hint "Es kann nur eine Person den Kofferaum benutzen."};
_vehicle setVariable["trunk_in_use",true,true];
if(!createDialog "TrunkMenu") exitWith {"Failed Creating Dialog";}; //Couldn't create the menu?
disableSerialization;
ctrlSetText[3501,format["Kofferaum - %1",getText(configFile >> "CfgVehicles" >> (typeOf _vehicle) >> "displayName")]];
