...
if(isNull _vehicle) exitWith {hint "Du musst dein Fahrzeug ansehen um es zu Tanken!"};
if(!(_vehicle isKindOF "LandVehicle") && !(_vehicle isKindOf "Air") && !(_vehicle isKindOf "Ship")) exitWith {};
if(player distance _vehicle > 7.5) exitWith {hint "Du musst in der nähe deines Fahrzeuges sein."};
