...
if(_door == 0) exitWith {hint "Du bist nicht in der Naehe einer Tuer!"}; //Not near a door to be broken into.
if((_building getVariable[format["bis_disabled_Door_%1",_door],0]) == 0) exitWith {hint "Diese Tuer ist bereits geoeffnet!"};
