...
if(isNil "_data") exitWith {_list lbAdd "Fehler beim Verbrechen laden";};
if(typeName _data != "ARRAY") exitWith {_list lbAdd "Fehler beim Verbrechen laden";};
if(count _data == 0) exitWith {_list lbAdd "Fehler beim Verbrechen laden";};
lbClear _list;
