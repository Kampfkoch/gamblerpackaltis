...
{
	titleText[format["Du hast den illegalen Gegenstand %1 beschlagnahmt. Dafür erhälst du eine Belohnung von $%2.",_itemName,[(life_illegal_items select _illegal) select 1] call life_fnc_numberText],"PLAIN"];
...
if(_diff <= 0) exitWith {hint "Du kannst das nicht aufheben , du bist voll."};
